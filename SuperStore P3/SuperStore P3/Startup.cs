...
namespace EcoPower_Logistics
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SuperStoreContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            ...
            services.AddTransient<IDOrderDetailsRepository, OrderDetailsRepository>();
